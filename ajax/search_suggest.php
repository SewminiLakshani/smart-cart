...
<?php else: foreach ($results as $r): $price = effective_price($r); ?>
  <a href="<?= BASE_URL ?>products/product-details.php?slug=<?= e($r['slug']) ?>" class="d-flex align-items-center justify-content-between text-white text-decoration-none p-2 rounded" style="transition:.2s" onmouseover="this.style.background='rgba(212,175,106,.08)'" onmouseout="this.style.background='transparent'">
