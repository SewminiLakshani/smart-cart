...
<nav class="navbar navbar-expand-lg sc-navbar">
  <div class="sc-container-fluid d-flex align-items-center justify-content-between w-100">
    ...
    <button class="navbar-toggler border-0 text-white" type="button" data-bs-toggle="offcanvas" data-bs-target="#scMobileNav">
    ...
    <div class="collapse navbar-collapse d-none d-lg-flex">
      <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item"><a class="nav-link <?= $currentPage === 'shop.php' ? 'active' : '' ?>" href="<?= BASE_URL ?>products/shop.php">Shop</a></li>
...
<div class="offcanvas offcanvas-start bg-sc-charcoal text-white" tabindex="-1" id="scMobileNav">
  ...
  <div class="offcanvas-body">
    <ul class="nav flex-column gap-2">
      <li><a class="nav-link text-white" href="<?= BASE_URL ?>index.php">Home</a></li>
      <li><a class="nav-link text-white" href="<?= BASE_URL ?>products/shop.php">Shop</a></li>
      <li><a class="nav-link text-white" href="<?= BASE_URL ?>index.php#categories">Categories</a></li>
      <li><a class="nav-link text-white" href="<?= BASE_URL ?>products/shop.php?deals=1">Deals</a></li>
      <li><a class="nav-link text-white" href="<?= BASE_URL ?>about.php">About Us</a></li>
      <li><a class="nav-link text-white" href="<?= BASE_URL ?>contact.php">Contact Us</a></li>
      <li><a class="nav-link text-white" href="<?= BASE_URL ?>customer/wishlist.php">Wishlist</a></li>
      <li><a class="nav-link text-white" href="<?= BASE_URL ?>customer/cart.php">Cart</a></li>
