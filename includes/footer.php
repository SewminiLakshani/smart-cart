    ...
    <div class="row g-4">
      ...
      <div class="col-lg-4">
        ...
        <ul class="list-unstyled d-flex flex-column gap-3 small">
          <li><span class="sc-footer-icon"><i class="bi bi-geo-alt"></i></span>142 Galle Road, Colombo 03, Sri Lanka</li>
          <li><span class="sc-footer-icon"><i class="bi bi-envelope"></i></span>support@smartcart.com</li>
          <li><span class="sc-footer-icon"><i class="bi bi-telephone"></i></span>+94 11 234 5678</li>
        </ul>
      </div>
    </div>
