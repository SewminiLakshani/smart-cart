...
<section class="sc-container-fluid pb-5">
  ...
  <div class="row mt-5" id="reviews">
    <div class="col-lg-8">
      ...
      <?php elseif ($user && $user['role_name'] === 'customer' && $alreadyReviewed): ?>
        <p class="text-secondary small mt-3"><i class="bi bi-check-circle me-1"></i>You've already reviewed this product. Thanks for sharing your feedback!</p>
